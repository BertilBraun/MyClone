...
CraftingTable::CraftingTable(Application& applic, Player* player) :
	StateBase(applic),
	invBackgound(glm::vec2(0.5f, 0.5f), glm::vec2(0.55f, 0.65f), "GUI/craftBackground.png", (*app->getWindow())),
...
void CraftingTable::handleInput(float deltaTime, const Camera & camera)
{
}

void CraftingTable::update(float deltaTime)
{
...
void CraftingTable::render(MasterRenderer & renderer)
{
